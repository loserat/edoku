...
// * INFO: Vorlage für eine neue Brandschottung. Optionale Felder bleiben leer, werden
// * INFO: aber bewusst mitgeführt, damit GUI, JSON und PDF dieselbe Struktur nutzen.
...
// * INFO: Pflichtfeldprüfung für Dashboard und Vollständigkeitsstatus.
function hasMissingRequiredBrandschutzFields(entry) {
  return BRANDSCHUTZ_REQUIRED_FIELDS.some((field) => !String(entry[field] || "").trim());
}

// * INFO: Normalisiert gespeicherte JSON-Daten und ergänzt fehlende Felder aus der Vorlage.
...
// * INFO: Wandelt Formularwerte aus der Tabelle zurück in die JSON-Struktur.
...
// * INFO: Fügt eine neue leere Schottung am Ende der vorhandenen Liste hinzu.
