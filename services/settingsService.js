...
const THEME_PRESETS = {
  ...
  "github-light-high-contrast": {
    ...
    preset: "github-light-high-contrast",
    mode: "light",
    colors: {
      bgLight: "#ffffff",
      bgDark: "#0d1117",
      ...
      textMuted: "#3f4650",
      textDark: "#f0f6fc",
      textMutedDark: "#bdc7d1",
      accent: "#0349b4",
      border: "#6e7781",
      borderDark: "#8b949e",
      buttonPrimary: "#0349b4",
    ...
    shape: DEFAULT_THEME_SHAPE,
    shadow: { strength: 8, softness: 20 },
    spacing: DEFAULT_THEME_SPACING,
    typography: DEFAULT_THEME_TYPOGRAPHY
  },
  "github-light-colorblind": {
    name: "GitHub Light Colorblind",
    preset: "github-light-colorblind",
    mode: "light",
    colors: {
      bgLight: "#f6f8fa",
      bgDark: "#0d1117",
  ...
  "github-dark-high-contrast": {
    ...
    preset: "github-dark-high-contrast",
    mode: "dark",
    colors: {
      bgLight: "#f6f8fa",
      bgDark: "#010409",
      ...
      surfaceMuted: "#f6f8fa",
      surfaceDark: "#0d1117",
      surfaceMutedDark: "#161b22",
      text: "#1f2328",
      textMuted: "#656d76",
      textDark: "#f0f6fc",
      textMutedDark: "#c9d1d9",
      accent: "#6cb6ff",
      border: "#d0d7de",
      borderDark: "#8b949e",
    ...
    shape: DEFAULT_THEME_SHAPE,
    shadow: { strength: 14, softness: 30 },
    spacing: DEFAULT_THEME_SPACING,
    typography: DEFAULT_THEME_TYPOGRAPHY
  },
  "github-dark-colorblind": {
    name: "GitHub Dark Colorblind",
    preset: "github-dark-colorblind",
    mode: "dark",
    colors: {
      bgLight: "#f6f8fa",
      bgDark: "#0d1117",
  ...
  "github-dark-dimmed": {
    ...
    shape: DEFAULT_THEME_SHAPE,
    shadow: { strength: 14, softness: 32 },
    spacing: DEFAULT_THEME_SPACING,
    typography: DEFAULT_THEME_TYPOGRAPHY
  }
};
